			...
			<div class="col s12 m4">
				<div class="card">
			        ...
			        <div class="card-content center">
			          <a href="backends/order-food.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: ;" class="btn waves-effect blue lighten-2 waves-block waves-light" href="">Order Now!</a>
			        </div>
				    </div>
